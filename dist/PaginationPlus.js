...
function refreshPage(targetNode, options) {
    ...
    targetNode.style.minHeight = `${_maxPage * options.pageHeight + (_maxPage - 1) * (_pageGap + 2 * _pageGapBorderSize)}px`;
